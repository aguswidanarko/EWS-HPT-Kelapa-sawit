...
export function canWriteMasterHptThreshold(user) {
  return hasRole(user, ROLES.ADMIN, ROLES.RND_FOD);
}

export function canChangeAlertStatus(user) {
  return hasRole(user, ROLES.ADMIN, ROLES.MANAGER, ROLES.ASKEP_ASISTEN, ROLES.RND_FOD);
}
...
export function canViewAuditLog(user) {
  return hasRole(user, ROLES.ADMIN, ROLES.RND_FOD, ROLES.MANAGER);
}
